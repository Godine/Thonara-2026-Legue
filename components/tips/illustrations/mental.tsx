...
function BreathingBetweenShots() {
  return (
    <g>
      ...
      <path d="M 138 60 C 130 50, 130 40, 140 32" fill="none" stroke={ACCENT} strokeWidth="1.2" opacity="0.45" strokeLinecap="round" />
      <path d="M 162 60 C 170 50, 170 40, 160 32" fill="none" stroke={ACCENT} strokeWidth="1.2" opacity="0.45" strokeLinecap="round" />
      <path d="M 144 70 C 134 62, 134 50, 146 44" fill="none" stroke={CHALK} strokeWidth="1" opacity="0.3" strokeLinecap="round" />
      <path d="M 156 70 C 166 62, 166 50, 154 44" fill="none" stroke={CHALK} strokeWidth="1" opacity="0.3" strokeLinecap="round" />
...
function PlayTheProcessNotTheScore() {
  return (
    <g>
      ...
      <line x1={185} y1={83} x2={245} y2={62} stroke={ACCENT} strokeWidth="1" strokeDasharray="2 2" opacity="0.6" />
...
function ConfidenceComesFromRepetition() {
  return (
    <g>
      <Felt />
      {/* row of small practice-shot balls */}
